    ...
    <header className="sticky top-0 z-50 bg-slate-900 border-b border-slate-800 shadow-md">
      <div className="h-16 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* NOTIFICATION */}
          <button className="relative w-10 h-10 rounded-lg bg-slate-800 hover:bg-slate-700 flex items-center justify-center transition">
          ...
          <div className="relative">
            ...
            >
              <div className="w-9 h-9 rounded-lg bg-blue-600 text-white flex items-center justify-center font-semibold text-sm shadow">
                {initials}
              </div>
            ...
            {/* DROPDOWN */}
            {open && (
              <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-200">
